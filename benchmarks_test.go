...
func Benchmark_V2_JSONToken_Encrypt(b *testing.B) {
  ...
  b.ResetTimer()
  for i := 0; i < b.N; i++ {
    _, _ = v2.Encrypt(symmetricKey, jsonToken, footer)
  }
}
...
func Benchmark_V2_JSONToken_Decrypt(b *testing.B) {
  ...
  b.ResetTimer()
  for i := 0; i < b.N; i++ {
    _ = v2.Decrypt(token, symmetricKey, &jsonToken, &footer)
  }
}
...
func Benchmark_V2_JSONToken_Sign(b *testing.B) {
  ...
  b.ResetTimer()
  for i := 0; i < b.N; i++ {
    _, _ = v2.Sign(privateKey, jsonToken, footer)
  }
}
...
func Benchmark_V2_JSONToken_Verify(b *testing.B) {
  ...
  b.ResetTimer()
  for i := 0; i < b.N; i++ {
    _ = v2.Verify(token, publicKey, &jsonToken, &footer)
  }
}
...
func Benchmark_V2_String_Encrypt(b *testing.B) {
  ...
  b.ResetTimer()
  for i := 0; i < b.N; i++ {
    _, _ = v2.Encrypt(symmetricKey, payload, footer)
  }
}
...
func Benchmark_V2_String_Decrypt(b *testing.B) {
  ...
  b.ResetTimer()
  for i := 0; i < b.N; i++ {
    _ = v2.Decrypt(token, symmetricKey, &payload, &footer)
  }
}
...
func Benchmark_V2_String_Sign(b *testing.B) {
  ...
  b.ResetTimer()
  for i := 0; i < b.N; i++ {
    _, _ = v2.Sign(privateKey, payload, footer)
  }
}
...
func Benchmark_V2_String_Verify(b *testing.B) {
  ...
  b.ResetTimer()
  for i := 0; i < b.N; i++ {
    _ = v2.Verify(token, publicKey, &payload, &footer)
  }
}
